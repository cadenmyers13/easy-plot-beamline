...
# -*- coding: utf-8 -*-
#
# easy-plot-beamline documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("easy_plot_beamline")
except Exception:
...
modindex_common_prefix = ["easy-plot-beamline"]
...
html_context = {
    "display_github": True,
    "github_user": "cadenmyers13",
    "github_repo": "easy-plot-beamline",
    "github_version": "main",
...
basename = "easy-plot-beamline".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "easy-plot-beamline.tex",
        "easy-plot-beamline Documentation",
        ab_authors,
        "manual",
    ),
]
